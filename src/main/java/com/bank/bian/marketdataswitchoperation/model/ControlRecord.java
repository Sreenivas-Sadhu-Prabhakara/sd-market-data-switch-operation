package com.bank.bian.marketdataswitchoperation.model;
...
/**
 * The BIAN control record for this service domain: "Market Data Feed Operating Session".
 *
 ...
 * to its asset type (Market Data Feed). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Market Data Feed Operating Session";
